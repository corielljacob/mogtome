...
// Shared components
import { Button, StoryDivider, FloatingSparkles, FloatingMoogles, SpotlightCard, DiscordIcon, type MoogleConfig } from '../components';
...
export function Home() {
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col relative pt-[calc(4rem+env(safe-area-inset-top))] md:pt-0 pb-[calc(5rem+env(safe-area-inset-bottom))] md:pb-0">
      ...
      <section className="flex-1 flex items-center justify-center px-4 py-8 md:py-16 relative z-10">
        <div className="relative max-w-2xl mx-auto">
          ...
          <SpotlightCard 
            className="bg-[var(--bento-card)]/80 backdrop-blur-md rounded-3xl p-5 sm:p-8 md:p-12 border border-[var(--bento-primary)]/10 shadow-xl shadow-[var(--bento-primary)]/10"
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.6 }}
            spotlightColor="color-mix(in srgb, var(--bento-primary), transparent 85%)"
            enableTilt={true}
          >
            {/* Corner flourishes */}
