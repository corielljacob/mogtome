...
const ITEMS: FloatConfig[] = [
  { left: '7%', size: 22, tint: 'var(--primary)', opacity: 0.5, duration: 18, delay: 0, kind: 'star' },
  { left: '21%', size: 15, tint: 'var(--accent)', opacity: 0.55, duration: 22, delay: 6, kind: 'sparkle' },
  { left: '39%', size: 18, tint: 'var(--secondary)', opacity: 0.45, duration: 19, delay: 10, kind: 'heart' },
  { left: '61%', size: 13, tint: 'var(--accent)', opacity: 0.55, duration: 24, delay: 3, kind: 'sparkle' },
  { left: '79%', size: 24, tint: 'var(--primary)', opacity: 0.45, duration: 16, delay: 12, kind: 'star' },
  { left: '91%', size: 16, tint: 'var(--secondary)', opacity: 0.5, duration: 20, delay: 8, kind: 'heart' },
];

const MOTIF = { star: KawaiiStar, sparkle: KawaiiSparkle, heart: KawaiiHeart } as const;
