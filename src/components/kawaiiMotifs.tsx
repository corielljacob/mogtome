...
export const KawaiiStar = memo(function KawaiiStar({ className = '', color }: MotifProps) {
  return (
...
export const KawaiiSparkle = memo(function KawaiiSparkle({ className = '', color }: MotifProps) {
  return (
    <svg {...svgProps(className)} style={color ? { color } : undefined}>
...
/** Soft heart. */
export const KawaiiHeart = memo(function KawaiiHeart({ className = '', color }: MotifProps) {
  return (
    <svg {...svgProps(className)} style={color ? { color } : undefined}>
...
/** Cute bow / ribbon. */
export const KawaiiBow = memo(function KawaiiBow({ className = '', color }: MotifProps) {
  return (
    <svg {...svgProps(className)} style={color ? { color } : undefined}>
...
export const KawaiiCloud = memo(function KawaiiCloud({ className = '', color }: MotifProps) {
  return (
    <svg
      viewBox="0 0 140 80"
      fill="currentColor"
