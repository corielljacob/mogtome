...
describe("AccessibilityProvider", () => {
  ...
  describe("toggleSetting", () => {
    ...
    it("toggles a boolean setting off", () => {
      localStorage.setItem(
        STORAGE_KEY,
        JSON.stringify({ enhancedFocus: true }),
      );
  ...
  describe("DOM class application", () => {
    ...
    it("applies extra-dark class", () => {
      ...
      expect(document.documentElement.classList.contains("extra-dark")).toBe(
        true,
      );
    });
    ...
    it("applies colorblind mode class", () => {
      ...
      expect(
        document.documentElement.classList.contains("colorblind-protanopia"),
      ).toBe(true);
    });
    ...
    it("removes previous colorblind class when changing modes", () => {
      ...
      expect(
        document.documentElement.classList.contains("colorblind-deuteranopia"),
      ).toBe(true);
    });
    ...
    it("removes colorblind class when set to none", () => {
      ...
      expect(
        document.documentElement.classList.contains("colorblind-tritanopia"),
      ).toBe(true);
...
function TestAccessibilityComponent() {
  ...
  return (
    <div>
      ...
      <button
        onClick={() =>
          updateSetting("colorblindMode", "protanopia" as ColorblindMode)
        }
      >
        Set Protanopia
      </button>
...
describe("Accessibility Component Integration", () => {
  ...
  it("toggles settings via button", () => {
    ...
    fireEvent.click(
      screen.getByRole("button", { name: "Toggle High Contrast" }),
    );
