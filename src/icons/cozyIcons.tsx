...
export const SlidersHorizontal = adapt(
  "SlidersHorizontal",
...
export const MessageCircle = adapt(
  "MessageCircle",
  "pepicons-pencil:text-bubble",
);
export const MessageSquare = adapt(
  "MessageSquare",
  "pepicons-pencil:text-bubble",
);
export const MessageCircleHeart = adapt(
  "MessageCircleHeart",
  "pepicons-pencil:text-bubble",
);
...
export const AlertCircle = adapt(
  "AlertCircle",
  "pepicons-pencil:exclamation-circle",
);
export const AlertTriangle = adapt(
  "AlertTriangle",
